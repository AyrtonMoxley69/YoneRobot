...
async def lego(event):
 ...
 try:
    ...
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By Akeno")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Report at @akeno_support_group, {e}')
...
async def lego(event):
 ...
 try:
   ...
   await event.reply(f'Error Report @akeno_support_group, {e}')
